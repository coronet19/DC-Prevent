...
LRESULT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    switch (uMsg) {
    case WM_CREATE: {
        HWND hCombo = CreateWindowW(L"COMBOBOX", NULL, WS_CHILD | WS_VISIBLE | CBS_DROPDOWNLIST,
            10, 10, 200, 200, hwnd, (HMENU)IDC_COMBO_MODE, g_hInst, NULL);
        ...
        CreateWindowW(L"BUTTON", L"Hide to Tray", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
            220, 8, 100, 24, hwnd, (HMENU)IDC_BTN_TRAY, g_hInst, NULL);

        CreateWindowW(L"LISTBOX", NULL, WS_CHILD | WS_VISIBLE | WS_VSCROLL | LBS_HASSTRINGS,
            10, 40, 460, 260, hwnd, (HMENU)IDC_LOG_LIST, g_hInst, NULL);
    } return 0;
